...
EndFunc
;TrayTipMsg("OutlookAuto", "Waiting " & $i &" mins for mails to download", 5)
...
Func Outlook_Launch_exit()
   ...
   For $i=30 to 0 Step -1
	  TrayTipMsg("OutlookAuto", "Waiting " & $i &" mins for mails to dowload", 5)
	  Sleep(1000*60)
   Next
...
Func Main()
   ...
   TrayTipMsg("OutlookAuto", "Running outlook in 60 sec", 5)
   Sleep(1000*60)
